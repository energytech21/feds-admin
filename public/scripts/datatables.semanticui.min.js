...
(function(b) {
  ...
  b.extend(!0, c.defaults, {
    dom:
      "<'ui stackable grid'<'row'<'eight wide column'l><'right aligned eight wide column'f>><'row dt-table'<'sixteen wide column'tr>><'row'<'seven wide column'i><'right aligned nine wide column'p>>>",
    renderer: "semanticUI"
  });
          ...
          if (((d = e[c]), b.isArray(d))) q(a, d);
            ...
            f &&
              ((l = b("<" + l + ">", {
                ...
                .html(f)
                .appendTo(a)),
              h.oApi._fnBindAction(l, { action: d }, m),
              p++);
          }
      },
      i;
  ...
  b(e).on("init.dt", function(a, e) {
    if ("dt" === a.namespace) {
      ...
      b.fn.dropdown &&
        b("div.dataTables_length select", c.table().container()).dropdown();
      b("div.dataTables_filter.ui.input", c.table().container())
        .removeClass("input")
        .addClass("form");
      b("div.dataTables_filter input", c.table().container()).wrap(
        '<span class="ui input" />'
      );
    }
  });
